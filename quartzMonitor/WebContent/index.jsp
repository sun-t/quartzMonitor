...
<!--		<style type="text/css">@import url('${pageContext.request.contextPath}/styles/home.css');-->
   ...
   <script type="text/javascript" src="/components/js/contacts.js"></script>
   ...
   <a href="<%=request.getContextPath()%>">新增定时任务</a></h3></p>
	 <fieldset>
      <pre>
        <h1 align="center" ><strong>定时任务发起页</strong></h1>
      </pre>
    </fieldset> 
    
<br/><br/>
        <form id="myForm1" action="<%=request.getContextPath()%>/JobProcessServlet?jobtype=0&action=add" method="post">
             
                    
           <table bgcolor="lightblue" width="800" height="500" align="center" style="border-collapse: collapse;" border="1" bordercolor="#006699">
                ...
                <tr>
                    ...
                    <td>
                        <select name="p_triggerGroup">
                            <option value="DEFAULF">默认组别</option>
                ...
                <tr>
                    ...
                    <td>
                     <img id="calBegin" src="components/calendar/skins/aqua/cal.gif" border="0" alt="开始时间" style="cursor:pointer" onclick='popUpCalendar(this,document.form1.TextBox1,"yyyy-mm-dd")'>
                       （Trigger执行开始时间，必填） 
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <tr>
                        <td colspan="3">
                           <h4 align="center" ><input type="submit" value="确认"> 
                           &nbsp;&nbsp;&nbsp;
                           <input type="reset" value="重置"></h4>
                        </td>
                    </tr>
                    </table>
                </form>
				...
				<br>
				<!-- 
                <form id="myForm2" action="<%=request.getContextPath()%>/JobProcessServlet?jobtype=1&action=add" method="post">
                    <table>
                        <tr>
				...
				<br>
				  ...
				  <form id="myForm3" action="<%=request.getContextPath()%>/JobProcessServlet?jobtype=2&action=add" method="post">
                    <table>
                        <tr>
